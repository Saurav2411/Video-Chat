        ...
        <div className="grid max-w-lg grid-cols-1 mx-auto lg:max-w-full lg:items-center lg:grid-cols-2 gap-y-12 lg:gap-x-16">
          <div>
            <div className="text-center lg:text-left">
              <h1 className="text-4xl font-bold leading-tight text-gray-900 sm:text-5xl sm:leading-tight lg:leading-tight lg:text-6xl font-pj">Connect to your freind and family</h1>
              <p className="mt-2 text-lg text-gray-600 sm:mt-8 font-inter">Get in contact to your knowns with ease and enjoy every moment.<br/>
              Without any signup.
             </p>
          ...
          <div>
            <img className="w-full " src="src\assets\istockphoto-1226976682-612x612.jpg" alt="" />
          </div>
        </div>
      </div>
    </section>
